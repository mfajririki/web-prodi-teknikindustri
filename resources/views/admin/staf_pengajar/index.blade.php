                        ...
                        <div class="card-header">
                            ...
                            <div class="modal fade" id="importExcel" tabindex="-1" role="dialog"
                                ...
                                <div class="modal-dialog modal-lg" role="document">
                                    <form method="post" action="/staf/import_excel" enctype="multipart/form-data">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                <h5 class="modal-title" id="exampleModalLabel">Import Excel</h5>
                                            </div>
                                            <div class="modal-body">
                                                <img src={{ asset('images/ContohImportStaf.png') }}
                                                    class="rounded mx-auto d-block" alt="Contoh penulisan excel"
                                                    width="700px">

                                                {{ csrf_field() }}

                                                <label>Pilih file excel </label><span class="text-danger">&nbsp; *csv,
                                                    xls, xlsx</span>
